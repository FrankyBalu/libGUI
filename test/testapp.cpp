...
int main ()
{
	...
	LIBGUI::PushButton PlayRadio (&HBox_RadioPlay, "PlayRadio");
	PlayRadio.LabelPressed ("  MDR Radio\nSachsen Anhalt", 0, 0, 0);
	PlayRadio.LabelUnPressed ("  MDR Radio\nSachsen Anhalt", 0, 0, 255);
	...
	MainWindow->GetRenderer()->SetDrawColor ( 0,255,0,0);
