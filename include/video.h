...
#ifndef __LIBGUI_Video__
#define __LIBGUI_Video__
...
public:
	...
	/**
 	 *  \brief Zerstört ein Fenster.
 	 */
	void DestroyWindow( RawWindow *win );
	
	
	/**
	 * Zum ermitteln der Fenstergröße
	 */
	void GetWindowSize(RawWindow *win, int *w, int *h);
	
};

}//namespace LIBGUI

#endif //__LIBGUI_Video__
